...
import { AgeGrading, type Model } from '@prisma/client'
...
const formSchema = z.object({
  ...
  weibo: z.string().nullable().transform(emptyStringToNull),
  homepage: z.string().nullable().transform(emptyStringToNull),
  onlyfans: z.string().nullable().transform(emptyStringToNull),
})
...
export type ModelFormProps = {
  ...
  createAction?: (values: z.infer<typeof formSchema>) => Promise<Model>
}

export function ModelForm({ initialValues, createAction, editAction }: ModelFormProps) {
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>微博的链接地址，用于统计社交媒体</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder='请输入模特OnlyFans连接'
                    {...field}
                    value={field.value || ''}
                  />
                </FormControl>
                <FormDescription>OnlyFans的链接地址，用于统计社交媒体</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
